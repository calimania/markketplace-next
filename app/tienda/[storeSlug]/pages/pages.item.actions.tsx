...
export default function PageItemActions({ storeSlug, itemDocumentId, editorId, isPublished = false, publishLabel = 'Publish' }: PageItemActionsProps) {
  ...
  return (
    <>
      ...
      <Button component="a" href={`/tienda/${storeSlug}/pages/${editorId}/edit`} variant="filled">
        Edit
      </Button>
    </>
  );
