...
// POST /api/crm/newsletters/:documentId/send
export async function POST(
  ...
  try {
    ...
    const upstreamUrl = new URL(`/api/crm/newsletters/${documentId}/send`, markketplace.api);
    ...
    console.error('[crm/newsletters/send] POST failed:', error);
